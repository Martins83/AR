...
async function getJSONAbilities() {
    const response = await fetch("https://github.com/Martins83/AR/main/docs/abilities.json"); //https://martins83.github.io/AR/docs/abilities.json    //https://github.com/Martins83/AR/tree/main/docs/abilities.json
